 ...
 * Description: A custom page template to display cities (projects count) in tabs with pagination.
 */


$theme_dir = get_template_directory_uri();

// إعداد الترقيم لاستعلام المدن
$paged  = ( get_query_var('paged') ) ? absint( get_query_var('paged') ) : 1;
$number = 9; // عدد المدن في كل صفحة
$offset = ( $paged - 1 ) * $number;

// الحصول على العدد الكلي للمدن
...
<div class="tabs-sec">
    <div class="container">
        ...
        <div class="tab-content">
                ...
                <div class="grid">
                    <?php if ( ! empty( $cities ) && ! is_wp_error( $cities ) ) : ?>
                        <?php foreach ( $cities as $city ) :
                            ...
                            // استعلام لحساب عدد المنشورات من نوع "projects" (Compounds)
                            ...
                            // استعلام لحساب عدد المنشورات من نوع "properties" (Properties)
            ...
            <!-- تبويبات أخرى (يمكن تعديل المحتوى ديناميكيًا حسب الحاجة) -->
