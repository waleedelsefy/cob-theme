...
<div class="areas">
    <div class="container">
        <div class="top-areas">
            ...
            <a class="areas-button" href="/areas/"> <?php esc_html__('View all', 'cob_theme'); ?>
        ...
        <div class="swiper mySwiper">
            <div class="swiper-wrapper">
                <?php
                // Retrieve up to 9 terms from the "city" taxonomy.
                $cities = get_terms([
                    'taxonomy'   => 'city',
                    'hide_empty' => false,
                    'number'     => 9,
                ...
                if ( ! empty( $cities ) && ! is_wp_error( $cities ) ) :
                    foreach ( $cities as $city ) :
                        // Get the term link and term name.
                        ...
                        // Retrieve the city's image via term meta (or use a default).
                        ...
                        // Count posts for another post type ("property") that belong to this city.
                        ...
                        <div class="swiper-slide">
                            <a href="<?php echo esc_url( $city_link ); ?>" class="card">
                                <svg width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                            d="M16.0555 18.1727V10.9445M16.0555 10.9445H8.82735M16.0555 10.9445L5.36827 21.6318M11.2552 24.78C14.8933 25.5005 18.8123 24.4511 21.6318 21.6318C26.1228 17.1407 26.1228 9.85932 21.6318 5.36828C17.1406 0.87724 9.85929 0.87724 5.36827 5.36828C2.54889 8.18766 1.49947 12.1067 2.21998 15.7448"
                                            stroke="#EC3C43" stroke-width="2.42105" stroke-linecap="round"
                        ...
                        <?php
                        // Reset post data after each WP_Query
                        wp_reset_postdata();
                    endforeach;
                else :
