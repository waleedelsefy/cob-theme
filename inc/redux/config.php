...
// Include Parent Tabs
require_once get_template_directory() . '/inc/redux/general-settings.php';
require_once get_template_directory() . '/inc/redux/property-settings.php';
require_once get_template_directory() . '/inc/redux/appearance-settings.php';
require_once get_template_directory() . '/inc/redux/social.php';
